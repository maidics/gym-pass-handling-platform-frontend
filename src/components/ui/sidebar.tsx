...
import { useIsMobile } from "@hooks/utils/useMobile.ts";
...
const sidebarMenuButtonBase = [
  ...
  "transition-[width,height,padding,background-color,color] duration-200 ease-in-out",
...
const sidebarMenuButtonVariants = cva(sidebarMenuButtonBase, {
  variants: {
    variant: {
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 cursor-pointer",
        "after:absolute after:-inset-2 after:md:hidden",
